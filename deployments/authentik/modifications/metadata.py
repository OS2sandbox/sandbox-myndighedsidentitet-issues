...
class MetadataProcessor:
    ...
    def get_encryption_key_descriptor(self) -> Optional[Element]:
        ...
        # TODO: This needs to check a source flag.
        if True:
            key_descriptor = Element(f"{{{NS_SAML_METADATA}}}KeyDescriptor")
    ...
    def build_entity_descriptor(self) -> str:
        ...
        entity_descriptor.attrib["ID"] = "OS2-AK-TEST" # Needs to be model field, if required.
        ...
        # TODO: Testing - need to be enabled by a flag.
        sp_sso_descriptor.attrib["AuthnRequestsSigned"] = "true"
        sp_sso_descriptor.attrib["WantAssertionsSigned"] = "true"
        ...
        for binding in [SAML_BINDING_POST, SAML_BINDING_REDIRECT]:
            sp_slo_descriptor = SubElement(sp_sso_descriptor, f"{{{NS_SAML_METADATA}}}SingleLogoutService")
            sp_slo_descriptor.attrib["Binding"] = binding
            sp_slo_descriptor.attrib["Location"] = self.source.slo_url
